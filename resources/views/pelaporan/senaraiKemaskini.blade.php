...
<div class="container-fluid">
  <div class="header">
    <h1 class="header-title">
        PELAPORAN JENIS TERNAKAN/TANAMAN <span style="text-transform: uppercase">{{$ternakan->nama}}</span>
    </h1>
  </div>
  <div class="card" style="width: auto;">
    <div class="card-header">
        <h3>SENARAI JENIS KEMASKINI</h3>
      </div>
    <div class="card-body" style="width: auto;">
      <div class="row d-flex justify-content-center">
        <table class="table table-bordered table-striped w-100 arial-N kemaskini-datatable">
...
<script type="text/javascript">
  $('.kemaskini-datatable').DataTable({
              ...
              ajax: "/pelaporan/kemaskiniList/".$idTernakan,
              columns: [{
                      data: 'DT_RowIndex',
                      name: 'DT_RowIndex',
