...
<div class="container-fluid">
    <div class="header">
        ...
        <a href="/user/tugasan/petiMasuk/{{$jawapan->id}}/user" class="frame9403-frame7445" style="margin-left:0px;">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                    ...
                    <table class="table table-borderless w-100" style="border: 0px;">
                        <tr style="border:0px">
                            ...
                            <td class="text-end" style="border:0px">
                                @if ($surat !=null)
                                    <form action="/user/tugasan/surat/view">
                ...
                <div class="card-body">
                    @if ($surat !=null)
                        <form action="/user/tugasan/surat/update" method="POST" onsubmit="return onSubmit(this)" id="form">
                            @csrf
                            @method('PUT')
