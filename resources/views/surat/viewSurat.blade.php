...
<style>
    ...
    <body>
        <div class="c18 doc-content">
            ...
            <table class="table table-borderless" style="margin-right: 0px; margin-left:auto; border: 0px;">
                <tr>
                    ...
                    <td class="borderless"><span class="c7"> - </span></td>
                </tr>
                <tr>
                    <td class="borderless"><span class="c7">Ruj. Kami </span></td>
                    <td class="borderless"><span>:</span></td>
                    <td class="borderless"><span class="c7"> {{$jawapan->borangs->no_rujukan}} ()</span></td>
                </tr>
                <tr>
                    <td class="borderless"><span class="c7">Tarikh </span></td>
                    <td class="borderless"><span>:</span></td>
                    <td class="borderless"><span class="c7"> {{date('d-m-Y', strtotime($hantar_surat->updated_at));}}</span></td>
                </tr>
            </table>
            ...
            <p class="c8 c35"><span class="c7"></span></p>
            <div class="c32">
                <p><span class="c2">𝐍𝐀𝐌𝐀 𝐏𝐄𝐍𝐆𝐔𝐒𝐀𝐇𝐀: {{$jawapan->nama}}</span></p>
                <p><span class="c2">𝐍𝐎 𝐊/𝐏: {{$kp->jawapan}}</span></p>
                <p>
                    <span class="c2">𝐏𝐑𝐎𝐉𝐄𝐊/𝐏𝐑𝐎𝐆𝐑𝐀𝐌 : 
                        @if (!$jawapan->jawapanMedan->isEmpty())
                            @foreach($jawapan->jawapanMedan as $medan)
                                {{$medan->jawapan ?? ""}}
                            @endforeach
                        @endif
                    </span>
                </p>
                <p><span class="c2">𝐑𝐀𝐍𝐂𝐀𝐍𝐆𝐀𝐍 : {{$jawapan->rancangans->nama}}</span></p>
                <p><span class="c2">𝐍𝐈𝐋𝐀𝐈 𝐆𝐄𝐑𝐀𝐍 : 𝐑𝐌 {{$jawapan->nilai_akhir}}</span></p>
            </div>
            <div class="c32">
            ...
            @if (!$carbon->isEmpty())
                <p class="c19">
                    ...
                    @foreach ($carbon as $cc)
                        <p><span class="c2">{{$cc->nama}}</span></p>
                    @endforeach
                </p>
            @endif
        </div>
        ...
        <div class="page_break">
                <div>
                    <p class="c32" style="text-align: center;"><span class="c10">LAMPIRAN 1</span></p>
                    <p class="c32" style="text-align: center;">
                       <span class="c10">SPESIFIKASI/PERINCIAN KERJA INFRASTRUKTUR BAGI PROJEK {{$jawapan->jawapanMedan[0]->jawapan ?? ""}}</span> 
                     </p>
                </div>
                <br>
                <table style="width:100%">
                    ...
                    @foreach($items as $item)
                        <tr style="height:30px">
                            <td class="perkara">{{$loop->iteration}}</td>
                            ...
                            <td class="perkara">
                                @if ($item->harga_akhir != null)
                                    {{$item->harga_akhir}}
                                    @php
                                        $amount +=((double) $item->harga_akhir);
                                    @endphp
                                @else
                                    {{$item->harga}}
                                    @php
                                        $amount +=((double)$item->harga);
                                    @endphp
                                @endif
                            </td>
                        </tr>
                    ...
                    <tr style="height:40px">
                        <td></td>
                        <td colspan="2" class="perkara">JUMLAH KESELURUHAN DI BAWA KE BORANG</td>
                        <td class="perkara">{{$amount}}</td>
                    </tr>
                </table>
            </div>
        </div>
