...
<div class="frame9403-frame9403">
  <div class="frame9403-frame9401">
      <span class="frame9403-text"><span>KEMASKINI MAKLUMAT PENGGUNA</span></span>
      <span class="frame9403-text02">
        <span>Sila isikan maklumat pengguna berikut dengan betul.</span>
      </span>
  </div>
  <form action="/pengurusanPengguna/kemaskini" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
      ...
      <div class="frame9403-frame9399">
        <div class="frame9403-frame7301">
          <div class="frame9403-group71881">
            ...
            <input type="text" class="frame9403-kotaknama" maxlength="100" size="100" value="{{$user->nama}}" name="nama">
          </div>
        </div>
        <div class="frame9403-frame9281">
          <div class="frame9403-group71881">
              <span class="frame9403-text04"><span>E-mel</span></span>
              <input type="email" class="frame9403-kotaknama" value="{{$user->email}}" name="email">
          </div>
        </div>
        <div class="frame9403-frame9278">
          <div class="frame9403-group71881">
            <span class="frame9403-text04">
              ...
              <input class="frame9403-kotaknama" type="text" name="nokadpengenalan" maxlength="12" size="12"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="{{$user->nokadpengenalan}}" required/>
            </span>
          </div>
        </div>
        ...
        <div class="frame9403-frame9281">
          <div class="frame9403-group71881">
            ...
            <i class="bi bi-eye-slash" id="togglePassword" style="position: absolute;
              right: -50px; padding: 10px 12px;margin-top: 7px; cursor: pointer;"></i>
            <input type="password" id="password" class="frame9403-kotaknama" name="password" minlength="8">
          </div>
        </div>
      </div>
      <div class="frame9403-frame9396">
        <div class="frame9403-frame9279">
          <div class="frame9403-group71881">
            ...
            <input type="text" class="frame9403-kotaknama" maxlength="12" size="12" value="{{$user->idPengguna}}" name="idPengguna">
          </div>
        </div>
        <div class="frame9403-frame9280">
          <div class="frame9403-group71881">
            <span class="frame9403-text04"><span>No. Telefon</span></span>
            <input type="text" class="frame9403-kotaknama" name="noTelefon" maxlength="11" size="11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="{{$user->notelefon}}" required>
          </div>
        </div>
        <div class="frame9403-frame92801">
          <div class="frame9403-group71881">
            ...
            <select name="wilayah" id="wilayah" class="frame9403-kotaknama3">
              <option value="{{$user->wilayah}}" selected style="display:none">{{$user->wilayah_id->nama}}</option>
        ...
        <div class="frame9403-frame92802">
          <div class="frame9403-group71881">
            ...
            <select name="rancangan" id="rancangan" class="frame9403-kotaknama3" required>
              <option value="{{$user->rancangan}}" selected style="display:none">{{$user->rancangan_id->nama}}</option>
            </select>
          </div>
        </div>
      </div>
