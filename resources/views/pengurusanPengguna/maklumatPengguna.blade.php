                ...
                <form action="/users/update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                          ...
                          <input type="text" class="form-control frame9403-kotaknama" maxlength="100" size="100" name="nama_asal" id="nama" oninput="this.value = this.value.toUpperCase()" value="{{Auth::user()->nama_asal}}"
                          @if(Auth::user()->kategoripengguna !="4")
                            readonly
                          @endif>
                        </div>
                        <div class="mb-3 col-md-6">
                          ...
                          size="12" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="{{Auth::user()->nokadpengenalan_asal}}" 
                          @if(Auth::user()->kategoripengguna !="4")
                            readonly
                          @endif>
                        </div>
