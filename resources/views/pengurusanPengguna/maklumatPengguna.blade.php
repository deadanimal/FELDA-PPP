                ...
                <div class="frame9403-frame9399">
                    ...
                    <div class="frame9403-frame9281">
                        <div class="frame9403-group71881">
                            ...
                            <input type="email" class="frame9403-kotaknama" value="{{ Auth::user()->email }}"
                                name="email">
                        </div>
                    </div>
                    <div class="frame9403-frame9278">
                        <div class="frame9403-group71881">
                            <span class="frame9403-text04">
                                ...
                                <input class="frame9403-kotaknama" type="text" name="nokadpengenalan" maxlength="12"
                                    size="12"
                    ...
                    <div class="frame9403-frame9283">
                        <div class="frame9403-group71881">
                            ...
                            @else
                                <input type="text" name="showkategoripengguna"class="frame9403-kotaknama"
                    ...
                    <div class="frame9403-frame9281">
                        <div class="frame9403-group71881">
                            ...
                            <i class="far fa-eye" onclick="showPassFunction()"
                                style="position: absolute;
              right: -50px; padding: 10px 12px;margin-top: 9px; cursor: pointer;"
                                id="iconPass"></i>
                            <input type="password" id="passcode" class="frame9403-kotaknama" name="password"
                                minlength="8">
                        </div>
                    </div>
                </div>
                <div class="frame9403-frame9396">
                    ...
                    <div class="frame9403-frame9280">
                        <div class="frame9403-group71881">
                            ...
                            <input type="text" class="frame9403-kotaknama" name="noTelefon" maxlength="11" size="11"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                $('select[name="rancangan"]').append('<option value="' +
                                    key + '">' + value + '</option>');
                            });
                        }
                    });
