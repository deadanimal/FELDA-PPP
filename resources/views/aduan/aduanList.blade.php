      ...
      <div class="card">
        <div class="card-header">
          <table style="width: 100%">
            <tr>
              <td><h1 style="font-family: 'Arial', sans-serif; font-size:23px;">Senarai Aduan</h1></td>
              <td>
                <button class="frame9403-frame7445"  data-toggle="modal" data-target="#exampleModalAddBorang">
                  <div class="frame9403-frame7293">
                  <span class="frame9403-text21"><span>Cipta Aduan</span></span>
            ...
            <div class="modal-content">
              ...
              <form action="/Aduan/add" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <textarea class="form-control frame9403-kotaknama" name="nama" id="nama" rows="4" oninput="this.value = this.value.toUpperCase()" required></textarea><br>
...
<script type="text/javascript">
    $('.aduan-datatable').DataTable({
                ...
                language: {
                    "search": "Carian:",
                    "lengthMenu": "Tunjuk _MENU_ Aduan",
                    "info": "Tunjuk _START_ ke _END_ dari _TOTAL_ Aduan",
                    "paginate": {
                        "first": "Pertama",
                        "last": "Akhir",
                        "next": "Seterusnya",
