    ...
    <div class="col-12">
      <div class="card">
        ...
        <table style="overflow: scroll; max-height: 750px; width:100%;">
          ...
          <tbody>
            @foreach($tahapKelulusan as $tKelulusan)
              <tr class="frame9402-input">          
                <form action="/moduls/borang/kelulusan/update" method="POST">
                  @csrf
                  @method('PUT')
                ...
                <div class="modal fade" id="exampleModal{{$tKelulusan->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Padam Tahap Kelulusan {{$tKelulusan->sequence}}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
          ...
          @else
            <tr class="frame9402-input" style="background-color: #FFFFFF; justify-content:center;"><td><h2 class="frame9402-text01" style="color:black;"> Tiada Tahap Kelulusan </h2></td></tr>
          @endif
        </table>
      </div>
    {{-- upload Borang --}}
