    ...
    <div class="row">
        <div class="col-12">
            <div class="tab">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item" style="background-color: rgb(210 210 210);">
                        <a class="nav-link active" data-bs-toggle="tab" href="#tab-5" style="height: 100%;">
                            <span class="arial-N">Surat {{$surat_penerimaan->jenis}}</span>
                        </a>   
                    </li>
                    <li class="nav-item" style="background-color: rgb(210 210 210);">
                        <a class="nav-link" data-bs-toggle="tab" href="#tab-6" style="height: 100%;">
                            <span class="arial-N">Surat {{$surat_janji->jenis}}</span>
                        </a>   
                    </li>
                </ul>
                <div class="tab-content">
                        ...
                        <div class="card-body" style="width: 80%; margin:auto;">
                            <table class="bdless" style="margin-right: 0px; margin-left:auto; border: 0px;">
                                <tr class="bdless">
                                    ...
                                    <td class="bdless"><span class="c7">{{ date('j F Y') }}</span></td>
                                </tr>
                            </table>
                            <p class="c32">
                                <span class="c10">{{$surat_penerimaan->title}}</span>
                            </p>
                            <p class="c8 c35"><span class="c7"></span></p>
                            <div class="c32">
                                <x-markdown>{!!$surat_penerimaan->body!!}</x-markdown>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="tab-6" role="tabpanel">
                        <div class="card-body" style="width: 80%; margin:auto;">
                            ...
                            <p class="c8 c35"><span class="c7"></span></p>
                            <p class="c32">
                                <span class="c10">{{$surat_janji->title}}</span>
                            </p>
                            <p class="c8 c35"><span class="c7"></span></p>
                            <div class="c32">
                                <x-markdown>{!!$surat_janji->body!!}</x-markdown>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/user/sub_borang/aku_janji" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <br/>
                        <div class="text-end">
                            <input type="hidden" name="jawapan_id" value="{{$borangJwpns->id}}">
                            <button type="submit" class="btn btn-primary btn-lg" style="margin-right: 4%; margin-top:1%;">Simpan & Setuju</button>
                        </div>
                    </form>
                </div>
            </div>
