      ...
      <div class="card">
        ...
        <table class="table table-bordered table-striped w-100 Arial">
          <thead class="text-white bg-primary w-100" style="text-align: center;">
            <tr>
                <th scope="col" class="Arial">Nama Projek</th>
          ...
          <tbody>
            @foreach ($jawapans as $jawapan)
                <tr>
                    ...
                    @else
                        <td class="text-center Arial" style="width: 25%">Sedang Di Proses</td>
                        <td class="text-center">
                            <a class="btn btn-info" href="/user/project/{{$jawapan->id}}" style="text-decoration:none;pointer-events: none;cursor: default; border: 1px solid #999999;background-color: #cccccc;">
                              Papar Projek
                            </a>
                        </td>
                    @endif                 
        ...
        @else
        <h1 style="text-align: center; padding-bottom:5%;">Tiada Projek Yang Dimohon</h1>
        @endif
      </div>
    </div>
  </div>
