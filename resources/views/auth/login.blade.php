                ...
                <div class="log-masuk-logbox">
                    ...
                    <div class="log-masuk-frame4">
                        <div class="log-masuk-frame121">
                            ...
                            <label>
                              <input class="log-masuk-rectangle461" type="password" name="password" id="passcode" placeholder="**************"/>
                              <i class="far fa-eye" onclick="showPassFunction()" style="cursor: pointer;color: #fff;" id="iconPass"></i>
                            </label>
                        </div>
