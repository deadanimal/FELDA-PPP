        ...
        <div class="card">
            <div class="card-header">
                <table style="width: 100%">
                    <tr>
                        <td><h1 style="font-family: 'Eina01-SemiBold', sans-serif; font-size:23px;">Senarai Galeri</h1></td>
                        <td>
                ...
                <tbody>          
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            ...
                            <a href="/home/page/item/{{$item->id}}" class=" btn frame9402-rectangle828246" style="margin-right: 10px;" title="Masuk">
